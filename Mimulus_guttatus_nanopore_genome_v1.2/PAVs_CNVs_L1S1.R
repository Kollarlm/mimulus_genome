...
write.table(unique(synt$id.x),file="supplemental_tables/L1_syntelogs.txt", 
            quote=FALSE,col.names=FALSE,row.names=FALSE) #Write table of syntenic genes for L1 and S1
write.table(unique(synt$id.y),file="supplemental_tables/S1_syntelogs.txt",
...
write.table(synt1x1$id.x,file="supplemental_tables/L1_1x1_syntelogs.txt",
            quote=FALSE,col.names=FALSE,row.names=FALSE)
write.table(synt1x1$id.y,file="supplemental_tables/S1_1x1_syntelogs.txt",
            quote=FALSE,col.names=FALSE,row.names=FALSE)
...
write.table(c(unique(L1nonsynt$id.x),L1u$id),file="supplemental_tables/L1_nonsyntenic.txt",
            quote=FALSE,col.names=FALSE,row.names=FALSE)
write.table(c(unique(S1nonsynt$id.y),S1u$id),file="supplemental_tables/S1_nonsyntenic.txt",
            quote=FALSE,col.names=FALSE,row.names=FALSE)
