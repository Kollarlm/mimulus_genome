...
#Set Path
runwd <- file.path("/Users/lesliekollar/Desktop/Mimulus_guttatus_nanopore_genome_v1.2")

gids <- c("L1","S1") #Whatever you list FIRST here will be the reference genome in the pan-genome function.
